export function rewardsPage(S,sb,esc,icons){
  ...
  if(!S.user)return `<section class="page rewards-page"><div class="rewards-hero"><div><span class="eyebrow dark">RECOMPENSAS</span><h1>Campanhas e benefícios</h1><p>Entre na sua conta para ver campanhas disponíveis e acompanhar suas solicitações.</p><a class="primary" href="#/login">Entrar na conta</a></div></div></section>`;
